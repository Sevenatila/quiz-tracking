...
export default function LandingScreenPT({ onStart }: LandingScreenProps) {
  ...
  return (
    ...
    >
      <div className="max-w-lg w-full text-center">
        ...
        >
          Descubra quanto dinheiro voc&ecirc; est&aacute;{' '}
        ...
        >
          Fazer diagn&oacute;stico gratuito
        ...
        >
          +12.000 diagn&oacute;sticos realizados
        </motion.p>
      </div>
    </motion.div>
  );
