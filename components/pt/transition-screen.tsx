...
const loadingSteps = [
  { text: "Analisando suas respostas...", icon: Search },
  { text: "Identificando vazamentos de dinheiro...", icon: Calculator },
  { text: "Calculando seu potencial de economia...", icon: Target }
];

export default function TransitionScreenPT({ onComplete }: TransitionScreenProps) {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full text-center">
        ...
        <p className="mt-4 text-slate-500 text-sm">Por favor, aguarde...</p>
      </div>
    </motion.div>
  );
}
